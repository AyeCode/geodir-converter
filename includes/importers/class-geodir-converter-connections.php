...
class GeoDir_Converter_Connections extends GeoDir_Converter_Importer {
	 ...
	 *
	 * Note: Connections uses a custom table structure, not standard post types.
	 *
	 * @var string
	 */
	const POST_TYPE_LISTING = 'cn_entry';
	 ...
	 * @var string
	 */
	const TAX_LISTING_CATEGORY = 'cn_category';
	...
	public function get_description() {
		return __( 'Import entries from your Connections Business Directory installation.', 'geodir-converter' );
	}
	...
	public function get_icon() {
		return GEODIR_CONVERTER_PLUGIN_URL . 'assets/images/connections.png';
	}
