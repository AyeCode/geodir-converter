<?php
/**
 * Sabai Directory Converter Class.
 *
 * @since     2.2.0
...
/**
 * Main converter class for importing from Sabai Directory.
 *
 * @since 2.2.0
 */
class GeoDir_Converter_Sabai_Directory extends GeoDir_Converter_Importer {
	/**
	 * Post type identifier for listings.
	 *
	 * @var string
	 */
	const POST_TYPE_LISTING = 'directory_listing';
	 ...
	 * @var string
	 */
	const TAX_LISTING_CATEGORY = 'directory_category';
	 ...
	 * @var string
	 */
	protected $importer_id = 'sabai_directory';
	...
	public function get_title() {
		return __( 'Sabai Directory', 'geodir-converter' );
	}
	...
	public function get_description() {
		return __( 'Import listings from your Sabai Directory installation.', 'geodir-converter' );
	}
	...
	public function get_icon() {
		return GEODIR_CONVERTER_PLUGIN_URL . 'assets/images/sabai-directory.png';
	}
	...
	public function render_settings() {
		...
		<form class="geodir-converter-settings-form" method="post">
			<h6 class="fs-base"><?php esc_html_e( 'Sabai Directory Importer Settings', 'geodir-converter' ); ?></h6>
